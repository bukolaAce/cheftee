  ...
  return (
    <>
      <div className="flex flex-col mb-10">
        <motion.h1 className="mb-5 text-3xl font-bold font-title text-[#151412]"
     ...
     exit='exit'>
      ...
      {prop.ingredients.length >= 4 && (
        <>
          {/* AI section   */}
          <motion.div   variants={containerVariantss}
     initial="hidden"
     animate="visible"
     exit='exit' className="bg-gray-200 p-5 rounded-lg md:w-[31rem] flex items-center justify-center h-32 w-[18rem]">
